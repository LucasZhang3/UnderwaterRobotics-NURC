...
#define DEPTH_KP 0               // Proportional correction for depth error in feet.
#define DEPTH_KI 0               // Integral correction for persistent depth error.
#define DEPTH_KD 0               // Derivative damping for depth-rate changes.
